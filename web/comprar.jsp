<%-- 
    Document   : comprar
    Created on : 7 oct. 2023, 15:06:18
    Author     : sebav
--%>
<%-- 
    Document   : recarga
    ...
    <body>
        ...
        <section class="services">
            <div class="container-cobro">
                ...
                <form id="formulario-pago" action="ControladorCompras">
                    ...
                    <a class="button" type="button" href="ControladorCompras?nroDoc=<%=pas.getNroDoc()%>">Pagar</a>
                </form>
