 ...
 <H1 class="card__title--center" id="pasajeroId" id-data="<%= pas.getId()%>">Selecciona tu Tarjeta a recargar</H1 >  
            <div class="metodos-contenedor">
                ...
                <div class="metodo">
                    ...
                    <input type="submit" value="Comprar" class="button" id="miBoton" id-data="TP-002">
                ...
                <div class="metodo">
                    ...
                    <input type="submit" value="Comprar" class="button" id="miBoton1" id-data="TP-001">
                ...
                <div class="metodo">
                    ...
                    <input type="submit" value="Comprar" class="button"  id="miBoton2" id-data="TP-001" >
