...
// Crear un objeto Pasajero con los valores obtenidos
            {               
                try {
                    pasajeroDao.edit(new Pasajero(null, null, nuevoNroDoc, nuevosNombres, nuevoApellidoPaterno, nuevoApellidoMaterno,formato.parse(nuevaFechaNacimiento), formato.parse(nuevaFechaRegistro), nuevoCorreo, nuevaContrasena, Integer.parseInt(nuevoTelefono)));
